 ...
 * the real backend (Socrata or ArcGIS). Not a snapshot test — only asserts
 * each query is still well-formed and returns at least one feature, catching
 * upstream renames/retirements of datasets or columns.
 */
