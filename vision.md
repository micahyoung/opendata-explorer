...
* The Vercel AI SDK packages the message alongside a curated, declarative system prompt containing schemas and worked examples for the five supported v1 datasets (e.g., *Dataset ID: erm2-nwe9, Fields: complaint_type, borough, created_date, location*).
