...
* **Point-Level Inspection:** A user can inspect any individual rendered point's details directly, without needing to ask the LLM a follow-up question. Inspection can be pinned open, and a point never silently hides that it represents more than one record.
